...
void driver(int forward,int sideways){
  int speed = 50;
  driveRightFront.spin(fwd,sin(PI * forward)*speed,pct);
  driveLeftFront.spin(fwd,sin(PI * forward)*speed,pct);
  driveRightBack.spin(fwd,sin(PI * forward)*speed,pct);
  driveLeftBack.spin(fwd,sin(PI * forward)*speed,pct);
}
